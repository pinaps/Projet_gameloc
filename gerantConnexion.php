...
if($resultUser) {
	...
	$isValidPassword = passport_verify($password,$resultUser['password']);
...
// Sinon on affiche un message d'erreur de connexion
	...
	$errors['password'] = "Le mot de passe est incorrecte";

}
}
else {
	$errors['user'] = "Erreur de l'email ou email non enregistré";
}
